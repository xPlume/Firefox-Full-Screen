...
1. Open Firefox and in the search bar, type **about:config**

2. In the search menu, write
```text
...
cd Firefox-Full-Screen
```

4. Open the folder of your Mozilla Firefox installation (typically for Windows under C:\Program Files\Mozilla Firefox).

5. Transfer the files **config.js** and **config.cfg** into the folder of your Mozilla Firefox installation. Admin priviledges may be required.

6. In that same folder, go to the directory *default/prefs/*, and inside it, paste the file **config-prefs.js**

7. Back to the Firefox browser, search for **about:support** and in the **Profile Folder** select "Open Folder".

8. Inside that folder, paste the **chrome/** directory provided in the repository.

9. Close and re-launch Firefox. Test the behavior after accessing any website (do not stay on the new tab page).
...
- Upon opening a new tab page, no difference should be noted. 
